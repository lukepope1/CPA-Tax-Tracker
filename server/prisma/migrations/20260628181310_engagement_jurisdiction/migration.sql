...
INSERT INTO "new_Engagement" ("assignedToId", "billed", "billedAmount", "billedDate", "clientId", "createdAt", "extensionFiled", "fiscalYearEndDay", "fiscalYearEndMonth", "formType", "id", "notes", "priorYearFee", "priorYearHours", "projectedFee", "status", "taxYear", "updatedAt") SELECT "assignedToId", "billed", "billedAmount", "billedDate", "clientId", "createdAt", "extensionFiled", "fiscalYearEndDay", "fiscalYearEndMonth", "formType", "id", "notes", "priorYearFee", "priorYearHours", "projectedFee", "status", "taxYear", "updatedAt" FROM "Engagement";
